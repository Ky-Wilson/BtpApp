...
<div class="container-fluid py-5 mb-5 hero-header">
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-md-12 col-lg-7">
                ...
                <h1 class="mb-5 display-3 text-primary">Trouvez la immeuble de vos rêves</h1>
                <div class="position-relative mx-auto">
                    <form action="{{ route('immeubles.index') }}" method="GET">
                        <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="text" name="location" placeholder="Rechercher une immeuble par localisation...">
                        ...
                        @foreach ($carousel_ads as $key => $ad)
                            <div class="carousel-item {{ $key == 0 ? 'active' : '' }} rounded">
                                @if (isset($ad->images[0]))
                                    <img src="{{ asset('storage/' . $ad->images[0]) }}" class="img-fluid w-100 rounded" style="height: 400px; object-fit: cover;" alt="immeuble {{ $ad->type }}">
                                @else
                                ...
                                @endif
                                <a href="{{ route('immeubles.show', $ad) }}" class="btn px-4 py-2 text-white rounded">
                                    Détails
                                </a>
                            </div>
                        @endforeach
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-10 text-end">
                            <ul class="nav nav-pills d-inline-flex text-center mb-5">
                                <li class="nav-item">
                                    <a class="d-flex m-2 py-2 bg-light rounded-pill {{ request('pieces') == null ? 'active' : '' }}" href="{{ route('immeubles.index') }}">
                                        <span class="text-dark" style="width: 200px;">Toutes les annonces</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="d-flex m-2 py-2 bg-light rounded-pill {{ request('pieces') == '1' ? 'active' : '' }}" href="{{ route('immeubles.index', ['pieces' => '1']) }}">
                                        <span class="text-dark" style="width: 130px;">1 pièce</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="d-flex m-2 py-2 bg-light rounded-pill {{ request('pieces') == '2-3' ? 'active' : '' }}" href="{{ route('immeubles.index', ['pieces' => '2-3']) }}">
                                        <span class="text-dark" style="width: 190px;">2-3 pièces</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="d-flex m-2 py-2 bg-light rounded-pill {{ request('pieces') == '4+' ? 'active' : '' }}" href="{{ route('immeubles.index', ['pieces' => '4+']) }}">
                            ...
                            <div class="col-lg-12">
                                <div class="row g-4">
                                    @forelse ($ads as $ad)
                                            ...
                                            <div class="rounded position-relative fruite-item d-flex flex-column" style="height: 440px;">
                                                ...
                                                <div class="p-3 border border-secondary border-top-0 rounded-bottom d-flex flex-column flex-grow-1">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap align-items-center mt-auto pt-2">
                                                        ...
                                                        <a href="{{ route('immeubles.show', $ad) }}" class="btn border border-secondary rounded-pill px-3 text-primary">
                                        ...
                                        @empty
                                            <p class="text-center" style="width: 100%;">Aucune annonce de immeuble trouvée pour ce nombre de pièces.</p>
                                        @endforelse
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="service-item bg-secondary rounded border border-secondary">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-primary text-center p-4 rounded">
                                        <h5 class="text-white">Publier votre immeuble</h5>
    ...
    <div class="container py-5">
        <div class="row g-4 align-items-center">
            <div class="col-lg-6">
                <div class="py-4">
                    <h1 class="display-3 text-white">Vendez votre immeuble</h1>
                    ...
                    <a href="{{ route('login') }}" class="banner-btn btn border-2 border-white rounded-pill text-dark py-3 px-5">Publier une immeuble</a>
                </div>
            </div>
            <div class="col-lg-6">
    ...
    <div class="container py-5">
        <div class="text-center mx-auto mb-5" style="max-width: 700px;">
            <h1 class="display-4">Nos immeubles en vedette</h1>
            <p>Découvrez une sélection de nos meilleures annonces de immeubles disponibles à l'achat ou à la location.</p>
        </div>
        <div class="row g-4">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded bg-light d-flex flex-column h-100">
                    ...
                    <div class="d-flex flex-column justify-content-between flex-grow-1">
                        <div>
                            <a href="{{ route('immeubles.show', $ad) }}" class="h5">{{ $ad->title }}</a>
                        ...
                        <div class="mt-auto">
                            ...
                            <a href="{{ route('immeubles.show', $ad) }}" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-eye me-2 text-primary"></i> Voir</a>
                        </div>
                    </div>
                </div>
            </div>
            @empty
                <p class="text-center" style="width: 100%;">Aucune immeuble trouvée.</p>
            @endforelse
        </div>
