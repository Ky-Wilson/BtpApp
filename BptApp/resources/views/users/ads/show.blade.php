...
<div class="container">
    <div class="card">
        <div class="card-body">
            <a href="{{ route('users.ads.index') }}" class="btn btn-secondary mb-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <span class="badge {{ $ad->is_approved ? 'bg-success' : 'bg-warning' }} text-dark mb-3">{{ $ad->is_approved ? 'Approuvée' : 'En attente' }}</span>
