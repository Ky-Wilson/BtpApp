...
{
    /**
     * Affiche toutes les annonces de la catégorie 'maison'.
     */
    public function index(Request $request)
    {
        // Récupérer la catégorie 'maison'
        $category = Category::where('name', 'maison')->firstOrFail();
        ...
        return view('site.maisons.index', compact('ads', 'featured_ads', 'category', 'categories', 'carousel_ads'));
    }
